...
class RJQET_OptionsManager {
    ...
    public function settingsPage() {
        if (!current_user_can('manage_options')) {
            wp_die(__('You do not have sufficient permissions to access this page.', 'rj-quick-empty-trash'));
        }
        ...
        ?>
        <div class="wrap">
            <h2><?php _e('System Settings', 'rj-quick-empty-trash'); ?></h2>
            <table class="form-table"><tbody>
            <tr><td><?php _e('System', 'rj-quick-empty-trash'); ?></td><td><?php echo php_uname(); ?></td></tr>
            <tr><td><?php _e('PHP Version', 'rj-quick-empty-trash'); ?></td>
                <td><?php echo phpversion(); ?>
                <?php
                if (version_compare('5.2', phpversion()) > 0) {
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    _e('(WARNING: This plugin may not work properly with versions earlier than PHP 5.2)', 'rj-quick-empty-trash');
                    echo '</span>';
                }
                ?>
                </td>
            </tr>
            <tr><td><?php _e('MySQL Version', 'rj-quick-empty-trash'); ?></td>
                <td><?php echo $this->getMySqlVersion() ?>
                    <?php
                    echo '&nbsp;&nbsp;&nbsp;<span style="background-color: #ffcc00;">';
                    if (version_compare('5.0', $this->getMySqlVersion()) > 0) {
                        _e('(WARNING: This plugin may not work properly with versions earlier than MySQL 5.0)', 'rj-quick-empty-trash');
                    }
                    echo '</span>';
                    ?>
                </td>
            ...
            <h2><?php echo $this->getPluginDisplayName(); echo ' '; _e('Settings', 'rj-quick-empty-trash'); ?></h2>
            ...
            <?php settings_fields($settingsGroup); ?>
                ...
                <p class="submit">
                    <input type="submit" class="button-primary"
                           value="<?php _e('Save Changes', 'rj-quick-empty-trash') ?>"/>
                </p>
            </form>
        </div>
        <?php
    ...
    protected function getOptionValueI18nString($optionValue) {
        switch ($optionValue) {
            case 'true':
                return __('true', 'rj-quick-empty-trash');
            case 'false':
                return __('false', 'rj-quick-empty-trash');

            case 'Administrator':
                return __('Administrator', 'rj-quick-empty-trash');
            case 'Editor':
                return __('Editor', 'rj-quick-empty-trash');
            case 'Author':
                return __('Author', 'rj-quick-empty-trash');
            case 'Contributor':
                return __('Contributor', 'rj-quick-empty-trash');
            case 'Subscriber':
                return __('Subscriber', 'rj-quick-empty-trash');
            case 'Anyone':
                return __('Anyone', 'rj-quick-empty-trash');
        }
        return $optionValue;
    }
